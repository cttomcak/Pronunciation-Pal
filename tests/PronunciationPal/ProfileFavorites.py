...
class ProfileFavorites(unittest.TestCase):
    ...
    def test_profile_favorites(self):
        ...
        time.sleep(.2)
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Favorite Words:'])[1]/preceding::button[1]").click()
        time.sleep(.2)
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Favorite Words:'])[1]/following::li[1]").click()
        time.sleep(.2)
        driver.find_element_by_xpath("//*/text()[normalize-space(.)='Hello']/parent::*").click()
        time.sleep(.2)
