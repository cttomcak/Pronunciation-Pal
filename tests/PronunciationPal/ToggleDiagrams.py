...
class ToggleDiagrams(unittest.TestCase):
    def setUp(self):
    ...
    def test_toggle_diagrams(self):
        ...
        time.sleep(.2)
        driver.find_element_by_xpath("//img[@alt='Viseme SS']").click()
        time.sleep(.2)
        driver.find_element_by_id("toggle_button").click()
        time.sleep(.2)
        driver.find_element_by_xpath("//img[@alt='Viseme SS']").click()
        time.sleep(.2)
        driver.find_element_by_id("toggle_button").click()
