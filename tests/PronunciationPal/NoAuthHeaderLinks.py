...
class NoAuthHeaderLinks(unittest.TestCase):
    def setUp(self):
    ...
    def test_no_auth_header_links(self):
        driver = self.driver
        ...
        time.sleep(.2)
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Register'])[1]/following::div[1]").click()
        time.sleep(.2)
