...
class AuthTogether(unittest.TestCase):
    def setUp(self):
    ...
    def test_auth_together(self):
        ...
        time.sleep(.2)
        driver.find_element_by_id("fname").send_keys("testname")
        time.sleep(.2)
        driver.find_element_by_id("lname").click()
        time.sleep(.2)
        driver.find_element_by_id("lname").clear()
        time.sleep(.2)
        driver.find_element_by_id("lname").send_keys("testname2")
        time.sleep(.2)
